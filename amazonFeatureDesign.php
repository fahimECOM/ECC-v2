        ...
        <div class="logo-row">
            <div class="logo-left">
                <div class="logo-left-header">
                    <p>We design Feature images</p>
                    <h2><span>Amazon Feature images </span> Design</h2>
                </div>
                <div class="logo-left-body">
                    <p>Ecomclips is a professional Feature Images Design services company, doing all kinds of Feature
                        Images with your raw Images. If you are looking for a trustworthy Feature Images for Your
                        Product to have your Feature Images and quickly Design, we will gladly fulfill the task.</p>
                </div>
                <div class="logo-left-button">
                    ...
                    <div class="hero-middle-button-services">
                        <p class="hero-middle-btnText">Need a Feature images Services?</p>
                        <div class="hero-middle-btnTwo-services">
                            <p class="hero-middle-btnText2">Create your Feature images</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="logo-right">
                <div class="logo-right-image">
                    <img src="images/portfolio/amazonFeatureDesign.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mobile-hero-container">
        <div class="mobile-hero-row">
            ...
            <div class="mobile-hero-body">
                <img src="images/a-plus-mobile/amazonbrand/feature-mobile.png" alt="" id="mobile_display">
                ...
                <div>
                    <img src="images/a-plus-mobile/amazonbrand/brand-dis-img-1.png" alt="" class="brand-dis-img-1"
                        onclick="mobile_display.src='images/a-plus-mobile/amazonbrand/feature-mobile.png'">
        ...
        <div class="slide-row">
            <div class="slide-left">
                <div class="slide-left-header">
                    <p>Feature images Design</p>
                    <h2><span>Our Portfolio</span> Work</h2>
                </div>
                <div class="slide-left-body">
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-1.png" id="imgSlide1" alt="" />
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-2.png" id="imgSlide2" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-3.png" id="imgSlide3" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-4.png" id="imgSlide4" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-5.png" id="imgSlide5" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-6.png" id="imgSlide6" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-7.png" id="imgSlide7" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-8.png" id="imgSlide8" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/amazonFeatureDesign-9.png" id="imgSlide9" alt="">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel"
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/portfolio/amazonFeatureDesign-slider.png" id="mainImage1" alt="...">
                        </div>
    ...
    <div class="portfolio-work-container">
        <div class="portfolio-work-row">
            ...
            <div class="portfolio-work-body">
                <img src="images/a-plus-mobile/packaging/packaging-slider-7.png" alt="" id="portfolioWorkimg">
            </div>
    ...
    <div class="jumpstart-container">
        <div class="jumpstart-row">
            <div class="slide-left-header">
                ...
                <h2>Jumpstart to Create your <span>Feature images Design</span></h2>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/lifestyle-image.png" alt="">
                </div>
            </div>
...
<section class="hide-for-mobile">
    <div class="color-container">
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/commercial-use.png" alt="">
                </div>
            </div>
            <div class="color-right">
                <div class="color-right-header">
...
<section class="hide-for-mobile">
    <div class="color-container">
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/free-mockup-feature.png" alt="">
                </div>
            </div>
            <div class="color-right">
                <div class="color-right-header">
