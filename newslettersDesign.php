...
<section class="hide-for-mobile">
    <div class="logo-container newsletter-hero">
        <div class="logo-row">
            <div class="logo-left">
                <div class="logo-left-header">
                    <p>Our Excellent Newsletter Designs Enable You To Express Your Approach</p>
                    <h2>Design <span>Email Newsletters</span></h2>
                </div>
                <div class="logo-left-body">
                    <p>Ecomalips is the most trusted agency in online photo retouching business since 2012. Simply
                        upload photos, write your requirements, and we'll take care of the rest.</p>
                </div>
            ...
            <div class="logo-right  news-pos">
                <div class="logo-right-image  logo-right-image-news">
                    <img src="images/portfolio/newsletters-img-2.png" alt="">
                </div>
                <img src="images/portfolio/laptop.png" alt="" class="image-sizzing">
            </div>
        </div>
        ...
        <div class="news-ab">
            <div class="news-rel">
                <div class="newsletter-layer-img">
                    <img src="images/portfolio/newsletters-img-1.png" alt="" class="news-img-1">
                    <img src="images/portfolio/newsletters-img-2.png" alt="" class="news-img-2">
                    <img src="images/portfolio/newsletters-img-3.png" alt="" class="news-img-3">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mobile-hero-container">
        <div class="mobile-hero-row">
            <div class="mobile-hero-header">
                <h4>Our Excellent Newsletter Designs Enable
                    You To Express Your Approach</h4>
                <div class="brand-heder-position">
                    <div class="brand-heder">
                        <h2><span>Design Email</span> <br>
                            Newsletters</h2>
            ...
            <div class="mobile-hero-body">
                <img src="images/a-plus-mobile/amazonbrand/newsletter.png" alt="" id="mobile_display">
                <div class="brand-mobile-image">
                    <img src="images/a-plus-mobile/amazonbrand/brand-hero-mobile.png" alt="">
                </div>
                <div>
                    <img src="images/a-plus-mobile/amazonbrand/newsletter-1.png" alt="" class="brand-dis-img-1"
                        onclick="mobile_display.src='images/a-plus-mobile/amazonbrand/newsletter.png'">
                    <img src="images/a-plus-mobile/amazonbrand/newsletter-2.png" alt="" class="brand-dis-img-2"
                        onclick="mobile_display.src='images/a-plus-mobile/amazonbrand/brand-hero-dis-2.png'">
                    <img src="images/a-plus-mobile/amazonbrand/newsletter-3.png" alt="" class="brand-dis-img-3"
            ...
            <div class="hero-bottom">
                <div class="peogessBarSection">
                    <h1 class="circle-progress-bar" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                        ...
                        <div>
                            <span id="featureNum1">300</span>
                            <span>+</span>
                        </div>
                    </h1>
                    <p>Experience of creating <br>
                        300+ Email Newsletters</p>
                </div>
                <div class="peogessBarSection">
    ...
    <div class="portfolio-work-container">
        <div class="portfolio-work-row">
            ...
            <div class="portfolio-work-body">
                <img src="images/a-plus-mobile/packaging/newsletter-portfolio.png" alt="" id="portfolioWorkimg">
            </div>
                ...
                <div class="portfolio-work-slider">
                    <div class="owl-slider">
                        <div id="carouselPortFolio" class="owl-carousel portfolio-work brand-owl">
                            <div class="item">
                                <div class="owl-icon-img">
                                    <img src="images/a-plus-mobile/packaging/newsletter-portfolio-1.png" alt=""
                                        onclick="portfolioWorkimg.src='images/a-plus-mobile/packaging/newsletter-portfolio.png'">
                                </div>
                            </div>
                            <div class="item">
                                <div class="owl-icon-img" onclick="portfolioWork(2)">
                                    <img src="images/a-plus-mobile/packaging/newsletter-portfolio-2.png" alt="">
                                </div>
                            </div>
                            <div class="item">
                                <div class="owl-icon-img" onclick="portfolioWork(3)">
                                    <img src="images/a-plus-mobile/packaging/newsletter-portfolio-3.png" alt="">
                                </div>
                            </div>
                            <div class="item">
            ...
            <div class="slide-left">
                ...
                <div class="slide-left-body">
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-1.png" id="imgSlide1" alt="" />
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-2.png" id="imgSlide2" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-3.png" id="imgSlide3" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-4.png" id="imgSlide4" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-5.png" id="imgSlide5" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-6.png" id="imgSlide6" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-7.png" id="imgSlide7" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-8.png" id="imgSlide8" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/newslettersDesign-9.png" id="imgSlide9" alt="">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel"
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/portfolio/newslettersDesign-slider.png" id="mainImage1" alt="...">
                        </div>
    ...
    <div class="jumpstart-container">
        <div class="jumpstart-row">
            <div class="slide-left-header">
                ...
                <h2><span>Jumpstart to Create</span> Email Newsletters </h2>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="high-end-row">
            ...
            <div class="high-end-right">
                <div class="end-right-image">
                    <img src="images/portfolio/jpg-png-file.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/multiple-size.png" alt="">
                </div>
            </div>
...
<section class="hide-for-mobile">
    <div class="color-container">
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/free-mockup-social.png" alt="">
                </div>
            </div>
            <div class="color-right">
                <div class="color-right-header">
