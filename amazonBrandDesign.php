        ...
        <div class="logo-row">
            <div class="logo-left">
                <div class="logo-left-header">
                    <p>We Create Brands Store</p>
                    <h2><span>Amazon Brand Store </span> Design</h2>
                </div>
                <div class="logo-left-body">
                    <p>Your hunt for a professional-looking Amazon Brand Store Designer ends here with Ecomclips. And a
                        journey of glamorous public visibility begins. We take care of all the logo and brand design
                        needs that are required for your business. Our logo design services and standards are perfect
                        with professionalism for brand recognition.</p>
                </div>
                <div class="logo-left-button">
                    ...
                    <div class="hero-middle-button-services">
                        <p class="hero-middle-btnText">Need a Amazon Brand store design?</p>
                        <div class="hero-middle-btnTwo-services">
                            <p class="hero-middle-btnText2">Create a Amazon Brand store design</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="logo-right">
                <div class="logo-right-image">
                    <img src="images/portfolio/amazonBrandDesign.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mobile-hero-container">
        <div class="mobile-hero-row">
            <div class="mobile-hero-header">
                <h4>We Create Brands Store</h4>
                <div class="brand-heder-position">
                    <div class="brand-heder">
                        <h2><span>Amazon Brand Store</span>
                            Design</h2>
            ...
            <div class="mobile-hero-body">
                <img src="images/a-plus-mobile/amazonbrand/brand-hero-dis.png" alt="" id="mobile_display">
                ...
                <div>
                    <img src="images/a-plus-mobile/amazonbrand/brand-dis-img-1.png" alt="" class="brand-dis-img-1"
                        onclick="mobile_display.src='images/a-plus-mobile/amazonbrand/brand-hero-dis.png'">
        ...
        <div class="slide-row">
            <div class="slide-left">
                <div class="slide-left-header">
                    <p>Gorgeous packaging design for your product</p>
                    <h2><span>Our Portfolio</span> Work</h2>
                </div>
                <div class="slide-left-body">
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-1.png" id="imgSlide1" alt="" />
                        <img src="images/portfolio/amazonBrandDesign-slider.png" class="image-hide" id="img1Sub1"
                            alt="" />
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-2.png" id="imgSlide2" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-3.png" id="imgSlide3" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-4.png" id="imgSlide4" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-5.png" id="imgSlide5" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-6.png" id="imgSlide6" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-7.png" id="imgSlide7" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-8.png" id="imgSlide8" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/packaging-product-9.png" id="imgSlide9" alt="">
    ...
    <div class="jumpstart-container">
        <div class="jumpstart-row">
            <div class="slide-left-header">
                ...
                <h2>Jumpstart to Create your<span> Amazon Brand Store Design</span></h2>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="high-end-row">
            <div class="high-end-left">
                <div class="end-left-header">
                    ...
                    <h2>Why should you trust
                        our <span>Brand store designers?</span></h2>
                </div>
        ...
        <div class="color-row">
            ...
            <div class="color-right">
                <div class="color-right-header">
                    ...
                    <h2>We have our very own
                        <span>in-house team</span> of experts
                    </h2>
                </div>
                <div class="color-right-body">
                    <p class="right-p-margin">We don't outsource any part of the Amazon A+ page
                    ...
                    <p>No matter how huge or small order is, we take great
        ...
        <div class="color-row">
            ...
            <div class="color-right">
                <div class="color-right-header">
                    ...
                    <h2>We will find <span>copyright
                            free images</span> for you.
                    </h2>
                </div>
                <div class="color-right-body">
                    <p class="right-p-margin">Are you planning to do lifestyle photography for your product,
                        because your competitors do so?
                    </p>
                    <p class="right-p-margin">Cut off that expenses and knock us to create special lifestyles
                        to give your product the ‘wow’ factor. Our Photoshop experts
                        will create eye-catching ‘photography’ for you without the
                        expensive studio setup, photographers and suitable locations
                        for your lifestyle shots, allowing CGI to do the hard work!
                    </p>
                    <p>And guess the best part of it? We offer thousands of royalty free
