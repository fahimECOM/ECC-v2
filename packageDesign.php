        ...
        <div class="logo-row">
            <div class="logo-left">
                <div class="logo-left-header">
                    <p>We design packaging</p>
                    <h2><span>Packaging (Gift Card) </span> Design</h2>
                </div>
                <div class="logo-left-body">
                    <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was
                        ...
                        dislikes, or avoids pleasure itself, because it is pleasure, but because</p>
                </div>
                <div class="logo-left-button">
                    ...
                    <div class="hero-middle-button">
                        <p class="hero-middle-btnText">Need a Package?</p>
                        <div class="hero-middle-btnTwo">
                            <p class="hero-middle-btnText2">Create your Package</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="logo-right">
                <div class="logo-right-image">
                    <img src="images/portfolio/packaging.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mobile-hero-container">
        <div class="mobile-hero-row">
            ...
            <div class="mobile-hero-body">
                <img src="images/a-plus-mobile/amazonbrand/packaging.png" alt="" id="mobile_display">
                ...
                <div>
                    <img src="images/a-plus-mobile/amazonbrand/brand-dis-img-1.png" alt="" class="brand-dis-img-1"
                        onclick="mobile_display.src='images/a-plus-mobile/amazonbrand/packaging.png'">
    ...
    <div class="jumpstart-container">
        <div class="jumpstart-row">
            <div class="slide-left-header">
                ...
                <h2>Jumpstart to Create your <span>Packaging Design</span></h2>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="high-end-row">
            <div class="high-end-left">
                <div class="end-left-header">
                    <p>Printable file</p>
                    <h2>Professional And Creative With <br>
                        <span>Printable file</span>
                    </h2>
                </div>
                <div class="end-left-body">
                    <p>A printable is a digital file (PDF or JPG file format depending
                        on the item you are purchasing – refer to the listing
                        description) that you purchase, download and can then print
                        endlessly for your personal use.</p>
                </div>
            </div>
            <div class="high-end-right">
                <div class="end-right-image">
                    <img src="images/portfolio/printable-file.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/die-cutting.png" alt="">
                </div>
            </div>
            <div class="color-right">
                ...
                <div class="color-right-body">
                    <p>Die cutting is a broad term, but in crafting, the act of die cutting refers to a process in which
                        you use a machine to mass-produce cut-out shapes. You can create the same shape, with the exact
                        same dimensions, over and over without using scissors, stencils, or a craft knife. It saves time
                        and makes your cut-out shapes look professional and consistent every time.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="hide-for-mobile">
    <div class="color-container">
        <div class="color-row">
            ...
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/free-mockup-packiging.png" alt="">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div id="carouselFreeMockup" class="owl-carousel why-should brand-owl">
                        <div class="item">
                            ...
                            <div class="owl-icon-provide">
                                <img src="images/a-plus-mobile/packaging.png" alt="">
                            </div>
