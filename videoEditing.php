        ...
        <div class="logo-row">
            <div class="logo-left">
                <div class="logo-left-header">
                    <p>We Edit Videos</p>
                    <h2><span>Video Editing</span> Services</h2>
                </div>
                <div class="logo-left-body">
                    <p>Ecomclips is a professional video editing services company, doing all kinds of
                        video editing with your raw footage. If you are looking for a trustworthy video
                        editing company to have your videos professionally and quickly edited, we will
                        gladly fulfill the task.</p>
                </div>
                <div class="logo-left-button">
                    ...
                    <div class="hero-middle-button-services">
                        <p class="hero-middle-btnText">Need a Video Editing Services?</p>
                        <div class="hero-middle-btnTwo-services">
                            <p class="hero-middle-btnText2">Create Video Editing Services</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="logo-right">
                <div class="logo-right-image">
                    <img src="images/portfolio/videoEditing.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mobile-hero-container">
        <div class="mobile-hero-row">
            ...
            <div class="mobile-hero-body">
                <img src="images/a-plus-mobile/amazonbrand/video-mobile-display.png" alt="" id="mobile_display">
                ...
                <div>
                    <img src="images/a-plus-mobile/amazonbrand/brand-dis-img-1.png" alt="" class="brand-dis-img-1"
                        onclick="mobile_display.src='images/a-plus-mobile/amazonbrand/video-mobile-display.png'">
    ...
    <div class="portfolio-work-container">
        <div class="portfolio-work-row">
            ...
            <div class="portfolio-work-body">
                <img src="images/a-plus-mobile/amazonbrand/video-portfolio.png" alt="" id="portfolioWorkimg">
            </div>
                        ...
                        <div id="carouselPortFolio" class="owl-carousel portfolio-work brand-owl">
                            <div class="item">
                                <div class="owl-icon-img"
                                    onclick="portfolioWorkimg.src='images/a-plus-mobile/amazonbrand/video-portfolio.png'">
                                    <img src="images/a-plus-mobile/amazonbrand/video-portfolio-1.png" alt="">
                                </div>
                            </div>
                            <div class="item">
    ...
    <div class="jumpstart-container">
        <div class="jumpstart-row">
            <div class="slide-left-header">
                ...
                <h2>Jumpstart to Create your <span>Video Editing</span></h2>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="high-end-row">
            ...
            <div class="high-end-right">
                <div class="end-right-image">
                    <img src="images/portfolio/hq-video.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/color-correction.png" alt="">
                </div>
            </div>
...
<section class="hide-for-mobile">
    <div class="color-container">
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/lifestyle-image-video.png" alt="">
                </div>
            </div>
            <div class="color-right">
                <div class="color-right-header">
                    ...
                    <div id="carouselFreeMockup" class="owl-carousel why-should brand-owl">
                        <div class="item">
                            ...
                            <div class="owl-icon-provide">
                                <img src="images/a-plus-mobile/video-laptop.png" alt="">
                            </div>
