...
<body class="" id="ID_for_scrollbar">
    <!-- Navigation Start -->
    <nav class="home-navber subcategory-nav" id="nav_sub_bg">
        <div class="content">
            ...
            <li class="home-mobile-hide"><a class="changeFontColorOnHover" href="#">Services</a></li>
                ...
                <li onclick="navDropdown()" id="hover-spinner" class="nav-circle-hover spinner circlehover blackspinner home-mobile-hide" style="margin-bottom: 42px; margin-right:10px"><a href="#"
                        class="nav-icon-r">
                        <svg id="Group_2058" data-name="Group 2058" class="changeSVG-sub-icon" xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54">
                        <g id="nav_1" data-name="nav 1">
                            <g id="Group_790" data-name="Group 790" transform="translate(13 22)">
                            <rect id="Rectangle_1409" data-name="Rectangle 1409" width="28" height="1.5" transform="translate(0 8)"/>
                ...
                <li onclick="navDropdownMobile()" class="nav-circle spin circle home-desktop-hide" style="margin-top: 12px;"><a href="#"
                        class="nav-icon-r">
                        <svg xmlns="http://www.w3.org/2000/svg" class="changeSVG-sub-icon" width="33" height="33" viewBox="0 0 26 26">
                        <g id="Group_1751" data-name="Group 1751" transform="translate(-1762 -13)">
                            ...
                            <g id="Group_790" data-name="Group 790" transform="translate(6.305 10.67)">
                                <rect id="Rectangle_1409" data-name="Rectangle 1409" width="13.58" height="0.728" transform="translate(0 3.88)"/>
                                <rect id="Rectangle_1412" data-name="Rectangle 1412" width="13.58" height="0.728" transform="translate(0 0)"/>
                            </g>
                            <g id="Ellipse_40" data-name="Ellipse 40" fill="none" stroke="#000" stroke-width="1" stroke-dasharray="176 200">
