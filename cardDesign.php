        ...
        <div class="logo-row">
            <div class="logo-left">
                <div class="logo-left-header">
                    <p>We design Id card/Visiting card</p>
                    <h2><span>ID /Visiting Card/Flyer </span> Design</h2>
                </div>
                ...
                <div class="logo-left-button">
                    ...
                    <div class="hero-middle-button">
                        <p class="hero-middle-btnText">Need a ID Card?</p>
                        <div class="hero-middle-btnTwo">
                            <p class="hero-middle-btnText2">Create your Id Card</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="logo-right">
                <div class="logo-right-image">
                    <img src="images/portfolio/cardDesign.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mobile-hero-container">
        <div class="mobile-hero-row">
            <div class="mobile-hero-header">
                ...
                <div class="brand-heder-position">
                    <div class="brand-heder">
                        <h2><span>ID card/Visiting card/Flyer</span>
                            Design</h2>
            ...
            <div class="mobile-hero-body">
                <img src="images/a-plus-mobile/amazonbrand/Free-Id-Card-Mockup-Template-scaled.png" alt=""
                    id="mobile_display">
    ...
    <div class="portfolio-work-container">
        <div class="portfolio-work-row">
            ...
            <div class="portfolio-work-body">
                <img src="images/a-plus-mobile/packaging/packaging-slider-6.png" alt="" id="portfolioWorkimg">
            </div>
            ...
            <div class="slide-left">
                ...
                <div class="slide-left-body">
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-1.png" id="imgSlide1" alt="" />
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-2.png" id="imgSlide2" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-3.png" id="imgSlide3" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-4.png" id="imgSlide4" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-5.png" id="imgSlide5" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-6.png" id="imgSlide6" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-7.png" id="imgSlide7" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-8.png" id="imgSlide8" alt="">
                    ...
                    <div class="logo-slider-image">
                        <img src="images/portfolio/cardDesign-9.png" id="imgSlide9" alt="">
    ...
    <div class="jumpstart-container">
        <div class="jumpstart-row">
            <div class="slide-left-header">
                ...
                <h2>Jumpstart to Create your<span> ID Card /Flyer Design</span></h2>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="high-end-row">
            ...
            <div class="high-end-right">
                <div class="end-right-image">
                    <img src="images/portfolio/printable-file-id.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/die-cutting-id.png" alt="">
                </div>
            </div>
...
<section class="hide-for-mobile">
    <div class="color-container">
        <div class="color-row">
            <div class="color-left">
                <div class="color-left-image">
                    <img src="images/portfolio/free-mockup-id.png" alt="">
                </div>
            </div>
            <div class="color-right">
                <div class="color-right-header">
